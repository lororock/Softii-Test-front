...
<template>
    <div class="bg-gray-200 w-64 mx-auto rounded-lg p-4 shadow-lg flex flex-col items-center justify-center">
            ...
            <button class="text-gray-600 hover:text-gray-800" @click="deleteNumber()">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
                        <g id="Icon-Set" sketch:type="MSLayerGroup" transform="translate(-516.000000, -1144.000000)"
                            fill="#000000">
                            <path
